...
Suppose all $nL$ coordinates of $(b_1,\dots,b_L)$ are mutually independent, each is symmetric about zero, and the entire bias array is independent of the weights. For every $n\ge1$, $L\ge2$, $\alpha>0$ and $0<\theta<1/4$,
\[
