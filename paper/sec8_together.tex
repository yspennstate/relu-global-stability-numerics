...
the counting & orthants met by an $n$-dimensional subspace of $\R^{nL}$, $\le 2e^{nLH(1/L)}$ & a net of a ball in $\R^{T+1}$, size independent of $N$\\
