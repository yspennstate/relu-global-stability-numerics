...
\bottomrule
\end{tabular}
\caption{The exact orbit identity \cref{eq:orbit} at width 2, $D_\ell=\diag(1,0)$ for odd $\ell$ and $D_\ell=I_2$ for even $\ell$ in every row; seed 8081 in \texttt{s7b\_gauge\_bounded.py}. The open orthants of $\im A_D$ are enumerated by boundary arcs.}
\label{tab:orbit}
\end{table}
