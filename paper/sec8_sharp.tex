...
\end{equation}
the same expansion as $h_{2e^{-\delta}}$ in \cref{eq:h-delta}. In particular $h_\alpha\ge g_\alpha$ pointwise for every $n$ by \cref{lem:h}, and the two agree to second order at zero.
\end{proposition}
